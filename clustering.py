...
if __name__ == '__main__':
    ...
    print(df.columns)
    """
    df = create_labeled_dataframe("minibatch_kmeans")
    print(df['label'])
    df = create_labeled_dataframe("hierarchical")
    print(df['label'])
    df = create_labeled_dataframe("dbscan")
    print(df['label'])
    df = create_labeled_dataframe("mean_shift")
    print(df['label'])"""
